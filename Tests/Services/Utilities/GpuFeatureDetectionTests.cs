...
public class GpuFeatureDetectionTests
{
    ...
    //[InlineData("Linux version 6.18.12+deb14-amd64 (debian-kernel@lists.debian.org) (x86_64-linux-gnu-gcc-15 (Debian 15.2.0-13) 15.2.0, GNU ld (GNU Binutils for Debian) 2.46) #1 SMP PREEMPT_DYNAMIC Debian 6.18.12-1 (2026-02-17) ", "17 Feb 2026")]
    ...
    //[InlineData("Linux version 6.8.0-100-generic (buildd@lcy02-amd64-008) (x86_64-linux-gnu-gcc-12 (Ubuntu 12.3.0-1ubuntu1~22.04.2) 12.3.0, GNU ld (GNU Binutils for Ubuntu) 2.38) #100~22.04.1-Ubuntu SMP PREEMPT_DYNAMIC Mon Jan 19 17:10:19 UTC ", "24 May 2023")]
    ...
    public void GetKernelDriverDate_ParsesDifferentFormatsCorrectly(string fileContent, string expectedDate)
    {
        ...
        try
        {
            string result = GpuFeatureDetection.GetKernelDriverDate(tempFilePath);
